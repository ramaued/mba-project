...
try:
        ...
        if username in usernames:
            if authentication_status:
                    with st.sidebar:
                        ...
                        support = st.slider("Masukkan nilai minimal support", min_value=0.001, max_value=0.009, value=0.003, help=support_helper)

                        st.markdown("\n")
                            
                        confidence = st.slider("Masukkan nilai minimal confidence", min_value=0.01, max_value=0.09, value=0.02, help=confidence_helper)
    ...
    st.warning('Halaman tidak dapat ditampilkan, muat ulang sekarang!')
